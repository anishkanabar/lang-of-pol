...
def clean_text_klm(text):
    ...
    text = re.sub('<X>\s?','',text)  # removes all <x> and space if one exists
    ...
    text = text.strip()
    text = text.lower() # keep in the end for uppercase chars in regex above
...
if __name__ == "__main__":
    ...
    #drop 323 transcriptions by user 'kristinakim'
