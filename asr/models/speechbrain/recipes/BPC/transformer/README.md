...
This folder contains recipes for tokenization and speech recognition with BPC, a policing communication ASR dataset.
...
```
cd ../../Tokenizer
python train.py hparams/train_transformer_tokenizer_bpe.yaml 
```
...
```
python train.py hparams/train_ASR_transformer.yaml 
```
