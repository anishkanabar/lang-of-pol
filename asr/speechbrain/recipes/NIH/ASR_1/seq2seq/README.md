...
```
cd ../../Tokenizer
python train.py hparams/tokenizer_bpe5000.yaml --data_folder=/localscratch/nih/
```
...
```
python train.py hparams/train.yaml --data_folder=/localscratch/nih/
```
